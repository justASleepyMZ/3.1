...
contract UniversityGroupToken {
    ...
    constructor(uint256 _initialSupply) {
        ...
        balanceOf[msg.sender] = totalSupply; // Mint initial supply to the deployer's address
        emit Transfer(address(0), msg.sender, totalSupply); // Emit transfer from address(0) to deployer
    }
