...
contract UniversityGroupToken {
    ...
    // Event declarations for transfer, approval, minting, and burning
    ...
    constructor(uint256 _initialSupply) {
        ...
        balanceOf[owner] = totalSupply; // Mint initial supply to the specified owner's address
        emit Transfer(address(0), owner, totalSupply); // Emit transfer from address(0) to specified owner
    }
